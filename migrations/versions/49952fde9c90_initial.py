...
def populate_billing_cycles(billing_cycles):
    op.bulk_insert(billing_cycles, [
        ...
        },
        {
            ...
            'end_date': datetime(2020, 3, 1, tzinfo=timezone.utc),
        }
    ])
    ...
    op.bulk_insert(data_usages, [
        {
            'id': 1,
            'mb_used': 121.522,
            'from_date': datetime(2020, 1, 20, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 20, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 1
        },
        {
            'id': 2,
            'mb_used': 519.984,
            'from_date': datetime(2020, 1, 21, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 21, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 1
        },
        {
            'id': 3,
            'mb_used': 22.362,
            'from_date': datetime(2020, 1, 24, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 24, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 1
        },
        {
            'id': 4,
            'mb_used': 450.759,
            'from_date': datetime(2020, 1, 3, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 3, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 2
        },
        {
            'id': 5,
            'mb_used': 560.811,
            'from_date': datetime(2020, 1, 10, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 10, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 4
        },
        {
            'id': 6,
        ...
        },
        {
            'id': 8,
            'mb_used': 470.288,
            'from_date': datetime(2020, 1, 9, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 9, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 6
        },
        {
            'id': 9,
        ...
        },
        {
            'id': 10,
            'mb_used': 1896.663,
            'from_date': datetime(2020, 1, 12, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 12, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 7
        },
        {
            'id': 11,
            'mb_used': 2216.993,
            'from_date': datetime(2020, 1, 13, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 13, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 7
        },
        {
            'id': 12,
            'mb_used': 1151.444,
            'from_date': datetime(2020, 1, 14, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 14, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 7
        },
        {
            'id': 13,
            'mb_used': 829.334,
            'from_date': datetime(2020, 1, 19, tzinfo=timezone.utc),
            'to_date': datetime(2020, 1, 19, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 2
        },
        {
            'id': 14,
            ...
            'to_date': datetime(2020, 1, 2, 23, 59, 59, 999999, tzinfo=timezone.utc),
            'subscription_id': 1
        },
        {
            'id': 15,
